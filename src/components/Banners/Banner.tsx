...
const Banner = () => {
  ...
  return isVisible == true ? (
    <div className="relative mb-2 flex-row-reverse rounded-sm isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 dark:bg-[var(--bgColor)] px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <div
        aria-hidden="true"
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm/6 text-right text-gray-900 dark:text-white">
          ...
          یلدای شما مبارک، به مناسب یلدا تخففیف های 10 تا 15 درصدی روی سرور ها
          قرار گرفت 🤞✌️
        </p>
      </div>
